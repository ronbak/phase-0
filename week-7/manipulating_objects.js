...
// I had trouble passing adding the names to the children property. It took me a while and some research to realize 
// that to add to the terah.children property you just had to add the child's name after (terah.children.name) and set
// it to a value of an object.

// 2. How difficult was it to add and delete properties outside of the object itself?
// I found it pretty easy to add and delete properties outside of the object. Especially once I figured out how to add
// properties to properties within the object.

// 3. What did you learn about manipulating objects in this challenge?
// I learned manipulating objects is easy and has many benefits.
// __________________________________________
